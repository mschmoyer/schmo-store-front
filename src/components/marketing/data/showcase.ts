...
import type { ShowcaseProduct, ShowcaseStore } from './showcase-model';

export type { ShowcaseProduct, ShowcaseStore } from './showcase-model';
export { interleaveProducts, pickHeroProduct } from './showcase-model';
