...
export interface PlatformRedemptionApiItem {
  ...
  /**
   * The live Stripe subscription status (`active`, `past_due`, `canceled`, …), or `null` when
   * there is none yet — only a `redeemed` claim ever has one, and only once it has synced.
   */
